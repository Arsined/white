...
/datum/religion_sect/mechanical
	...
	desc = "Библии могут заряжать киборгов и исцелять роботизированные конечности, но больше не будут исцелять органиков. Батарейки дарят благосклонность 
	в зависимости от того, насколько они заряжены."
	tgui_icon = "robot"
