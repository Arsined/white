                  ...
                  <Stack fill>
                    ...
                    <Stack.Item>
                      <Button
                        ...
                        Для этого, он использует контракты. Подписание контракта вашем именем 
                        подтвердит условия битвы. Затем человек, с которым вы намерены
                        провести спарринг должен подписать другую сторону. Если правила,
                        уже подписанного договора, изменятся, то 
                        подписи сотрутся и новые условия должны быть
                        повторно подписаны.
                        `}
                        icon="info">
                        Контракт?
